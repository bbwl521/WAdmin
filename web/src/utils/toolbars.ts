...
export default function toolbars() {
  ...
  const defaultToolbars = ref<MineToolbar[]>([
    ...
    {
      name: 'notification',
      title: 'wAdmin.toolbars.notification',
      icon: 'heroicons:bell',
      show: true,
    ...
    },
    {
      ...
      title: 'wAdmin.toolbars.translate',
      show: true,
    ...
    },
    {
      ...
      title: 'wAdmin.toolbars.fullscreen',
      show: true,
    ...
    },
    {
      ...
      title: 'wAdmin.toolbars.switchMode',
      show: true,
    ...
    },
    {
      ...
      title: 'wAdmin.toolbars.settings',
      show: true,
