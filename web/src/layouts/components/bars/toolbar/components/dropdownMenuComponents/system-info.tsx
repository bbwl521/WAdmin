    ...
    return () => (
      <>
        <m-drawer
          ...
          title={useTrans('wAdmin.userBar.systemInfo')}
        >
          <div class="mb-5 mt-2 text-left text-lg">
            {useTrans('wAdmin.runtime.coreInfo')}
          </div>
          <div class="mine-desc-info">
            <div class="mine-desc-label">{useTrans('wAdmin.runtime.lastBuildTime')}</div>
            <div class="mine-desc-value">{lastBuildTime}</div>
          </div>
          <div class="mine-desc-info">
            <div class="mine-desc-label">{useTrans('wAdmin.runtime.systemVersion')}</div>
            <div class="mine-desc-value">{`v${pkg.version}`}</div>
          </div>
          <div class="my-5 text-left text-lg">
            {useTrans('wAdmin.runtime.dependencies')}
          </div>
          {
          ...
          <div class="my-5 text-left text-lg">
            {useTrans('wAdmin.runtime.devDependencies')}
          </div>
          {
